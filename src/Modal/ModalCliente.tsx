...
export function ModalCliente({ handleClose }: ModalClienteProps) {
    ...
    /*    const logoMariaBase64 = logoMaria('logoMaria.jpg');
       const imgSolidBase64 = imgSolid('imgSolid.jpg');
       const whatsIconBase64 = whatsIcon('whats.png');
       const instagramIconBase64 = instagramIcon('instagram.png'); */
    ...
    let generatePDF = async () => {
        try {
            // Aguarde as imagens serem baixadas antes de continuar
            const [logoMariaBase64, imgSolidBase64, whatsIconBase64, instagramIconBase64] = await Promise.all([
                logoMaria('logoMaria.jpg'),
                imgSolid('imgSolid.jpg'),
                whatsIcon('whats.png'),
